    ...
    <div class="userSideNav-container">
        <ul class="user-sidenav--links list-unstyled">
            <% loop $VisibleUserNavigation %>
                <li class=""><a href="$PageLink.Link" class="<% if $Up.URLSegment == $PageLink.URLSegment %>active<% end_if %>"><span class="halyard-display fontsize20 font-weight-medium lineheight-30px">$Name</span></a></li>
            <% end_loop %>
