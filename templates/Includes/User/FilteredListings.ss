    ...
    <% else %>
        <div class="col-lg-12">
            ...
            <div class="pt-lg-7 pt-5">
                ...
                <p class="mb-5"><span class="halyard-display fontsize16 font-weight-book">Try a full site search using the magnifying glass in the upper right corner.</span></p>
                <hr>
            </div>
        </div>
    <% end_if %>
