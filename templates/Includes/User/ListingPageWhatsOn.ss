                ...
                <div class="row">
                    <% if $Listing.VisibleDatesAndTimes %>
                        ...
                        <% loop $Listing.VisibleDatesAndTimes %>
                            <div class="col-lg-5 col-sm-3 col-6 offset-lg-2 pb-lg-1 pb-2">
                                <p><span class="fontsize19 font-weight-book">$Date.Format('E, dd LLL')</span></p>
                            </div>
                            <div class="col-lg-5 col-sm-7 col-6 pb-lg-1 pb-2">
                    ...
                    <div class="col-lg-12 offset-lg-2 pb-lg-1 pb-2">
                        ...
                        <p class="pt-4"><a target="_blank" href="<% if $Listing.BookingURL %>$Listing.BookingURL<% else %>#<% end_if %>"> <span class="fontsize16 font-weight-medium text-underline">Buy tickets</span></a></p>
                    </div>
                    ...
                    <div class="col-lg-12 offset-lg-2 pb-lg-1 pb-2">
                        <% if $Listing.Phone %><p class="pb-3"><a href="tel:{$Listing.Phone}"><i class="fas fa-phone-alt mr-lg-3 mr-1 fontsize20 align-middle"></i><span class="fontsize19 font-weight-book moderna-sans">$Listing.Phone</span></a></p><% end_if %>
                        <% if $Listing.Email %><p class="pb-3"><a href="mailto:{$Listing.Email}"><i class="fas fa-envelope mr-lg-3 mr-1 fontsize20 align-middle"></i><span class="fontsize19 font-weight-book moderna-sans">$Listing.Email</span></a></p><% end_if %>
                        <% if $Listing.Website %><p class="pb-3"><a href="//$Listing.Website" target="_blank" rel="nofollow"><i class="fas fa-globe mr-lg-3 mr-1 fontsize20 align-middle"></i><span class="fontsize19 font-weight-book moderna-sans">$Listing.Website</span></a></p><% end_if %>
                        <% if $Listing.Facebook %><p class="pb-3"><a href="//$Listing.Facebook" target="_blank" rel="nofollow"><i class="fab fa-facebook-f mr-lg-3 mr-1 fontsize20 align-middle"></i><span class="fontsize19 font-weight-book moderna-sans">$Listing.Facebook</span></a></p><% end_if %>
                        <% if $Listing.Instagram %><p class="pb-3"><a href="//$Listing.Instagram" target="_blank" rel="nofollow"><i class="fab fa-instagram mr-lg-3 mr-1 fontsize20 align-middle"></i><span class="fontsize19 font-weight-book moderna-sans">$Listing.Instagram</span></a></p><% end_if %>
                        <% if $Listing.Twitter %><p class="pb-3"><a href="//$Listing.Twitter" target="_blank" rel="nofollow"><i class="fab fa-twitter mr-lg-3 mr-1 fontsize20 align-middle"></i><span class="fontsize19 font-weight-book moderna-sans">$Listing.Twitter</span></a></p><% end_if %>
                    </div>
