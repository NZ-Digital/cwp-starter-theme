...
<%--                    <button class="btn-utils downloadlisting fontsize25 ml-3 text-scorpion"><i class="fas fa-arrow-alt-to-bottom"></i></button>--%>
                    ...
                    <% if $Listing.BookingURL %><p class="ml-3"><a target="_blank" href="$Listing.BookingURL"><span class="theme-button-gray-small font-weight-medium fontsize18 text-center">Buy tickets</span></a></p><% end_if %>
                </div>
            </div>
        </div>
