                        ...
                        <div class="listing-action">
                            <div class="dropdown show">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                    ...
                                    <button type="button" class="dropdown-item" data-toggle="modal" data-target="#delete-listing-{$ID}">
                                        <span class="fontsize14 font-weight-medium text-footer-gray">Delete listing</span>
                                    </button>
                                </div>
                            </div>
                        </div>
