                            ...
                            <div class="newslist-content--details">
                                <div class="row">
                                    ...
                                    <div class="col-lg-10 pr-lg-7">
                                        ...
                                        <p><a href="<% if $Page %>$Page.Link<% else %>#<% end_if %>" class="text-decoration-none"><span class="halyard-display fontsize19 font-weight-book line-height-140 text-scorpion">{$ContentSummary.LimitWordCount(60).RAW}</span></a></p>
