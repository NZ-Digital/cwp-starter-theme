<div class="accordion-container">
    <div class="row no-gutters">
        <% if $Content %>
            <div class="col-lg-4">
                <p class="text-left pt-1"><span class="fontsize80 font-weight-light yellow-line">$Header</span></p>
                <div class="pt-lg-6 pt-5 padding-left-100px mobile-right-padding tablet-right-padding">
                    $Content
                </div>
            </div>
        <% end_if %>
        <% if $VisibleAccordionItems %>
            ...
            <div class="pt-lg-5 pl-lg-5 pb-lg-0 pb-5 padding-right-100px">
                <div class="accordion" id="accordion">
                    <% loop $VisibleAccordionItems %>
                        ...
                        <% end_if %>
                        <div class="card" id="accordion-item{$ID}">
