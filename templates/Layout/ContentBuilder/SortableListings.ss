<div class="sortableListings-container pt-lg-8 pb-lg-6 inner-padding mobile-padding tablet-padding" id="sortable-listings" <% if not $FilteredListings %>style="background-color: #f0efed;"<% end_if %>>
